...
#define STRING_CONFIG_H_AUTHOR "Prahjister" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_PRINTABLE_RADIUS 125 // mm
  ...
  #define DELTA_RADIUS 177.0 //mm  Get this value from auto calibrate
...
#define DEFAULT_ZJERK                 4.0 // Must be same as XY for delta
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER +26.26   // Y offset: -front +behind [the nozzle]

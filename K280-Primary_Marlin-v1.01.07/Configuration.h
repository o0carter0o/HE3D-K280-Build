...
#define STRING_CONFIG_H_AUTHOR "ZachTheZorcher" // Who made the changes.
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS 147 // mm
  ...
  #define DELTA_HEIGHT 600.00 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 180.0 //mm  Get this value from auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 140.7 }  // default steps per unit for Kossel (GT2, 20 tooth). zcarter, modified z steps from default
 ...
 *   Prahjister Uncomment this to use provided probe or someother probe
 */
#define FIX_MOUNTED_PROBE

/**
 * Z Servo Probe, such as an endstop switch on a rotating arm. 
 * Prahjister comment this if you want to use provided probe or some other type of probe
 */
 ...
 * Prahjister Comment Filament Runout sensor if you do not want to use
 */
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define G26_MESH_VALIDATION   // Enable G26 mesh validation
    ...
    //zcarter commented out hotend temp for nozzle-attached z-probe
